...
***Gaze of Two Minds.*** *Prerequisite: *
...
***Gift of the Depths.*** *Prerequisite: *
...
***Gift of the Protectors.*** *Prerequisite: *
...
***Investment of the Chain Master.*** *Prerequisite: *
...
***Lessons of the First Ones.*** *Prerequisite: *
...
***Level 3: Archfey Spells.*** The magic of your patron ensures you always have certain spells ready; when you reach a Warlock level specified in the Archfey Spells table, you thereafter always have the listed spells prepared.
...
***Level 3: Steps of the Fey.*** Your patron grants you the ability to move between the boundaries of the planes. You can cast *Misty Step* without expending a spell slot a number of times equal to your Charisma modifier (minimum of once), and you regain all expended uses when you finish a Long Rest.
...
***Level 6: Misty Escape.*** You can cast *Misty Step* as a Reaction in response to taking damage.
...
***Level 10: Beguiling Defenses.*** Your patron teaches you how to guard your mind and body. You are immune to the Charmed condition.
...
***Level 14: Bewitching Magic.*** Your patron grants you the ability to weave your magic with teleportation. Immediately after you cast an Enchantment or Illusion spell using an action and a spell slot, you can cast *Misty Step* as part of the same action and without expending a spell slot.
...
***Level 6: Radiant Soul.*** Your link to your patron allows you to serve as a conduit for radiant energy. You have Resistance to Radiant damage. Once per turn, when a spell you cast deals Radiant or Fire damage, you can add your Charisma modifier to that spell's damage against one of the spell's targets.

***Level 10: Celestial Resilience.*** You gain Temporary Hit Points whenever you use your Magical Cunning feature or finish a Short or Long Rest. These Temporary Hit Points equal your Warlock level plus your Charisma modifier. Additionally, choose up to five creatures you can see when you gain the points. Those creatures each gain Temporary Hit Points equal to half your Warlock level plus your Charisma modifier.
...
***Level 3: Fiend Spells.*** The magic of your patron ensures you always have certain spells ready; when you reach a Warlock level specified in the Fiend Spells table, you thereafter always have the listed spells prepared.
...
***Level 3: Dark One's Blessing.*** When you reduce an enemy to 0 Hit Points, you gain Temporary Hit Points equal to your Charisma modifier plus your Warlock level (minimum of 1 Temporary Hit Point). You also gain this benefit if someone else reduces an enemy within 10 feet of you to 0 Hit Points.

***Level 6: Dark One's Own Luck.*** You can call on your fiendish patron to alter fate in your favor. When you make an ability check or a saving throw, you can use this feature to add 1d10 to your roll. You can do so after seeing the roll but before any of the roll's effects occur.
...
***Level 3: Great Old One Spells.*** The magic of your patron ensures you always have certain spells ready; when you reach a Warlock level specified in the Great Old One Spells table, you thereafter always have the listed spells prepared.
...
***Level 3: Awakened Mind.*** You can form a telepathic connection between your mind and the mind of another. As a Bonus Action, choose one creature you can see within 30 feet of yourself. You and the chosen creature can communicate telepathically with each other while the two of you are within a number of miles of each other equal to your Charisma modifier (minimum of 1 mile). To understand each other, you each must mentally use a language the other knows.
...
***Level 10: Thought Shield.*** Your thoughts can't be read by telepathy or other means unless you allow it. You also have Resistance to Psychic damage, and whenever a creature deals Psychic damage to you, that creature takes the same amount of damage that you take.

***Level 14: Create Thrall.*** When you cast *Summon Aberration*, you can modify it so that it doesn't require Concentration. If you do so, the spell's duration becomes 1 minute for that casting, and when summoned, the Aberration has a number of Temporary Hit Points equal to your Warlock level plus your Charisma modifier.
...
***Expanded Spell List.*** *1st-level Fathomless feature*
...
***Tentacle of the Deeps.*** *1st-level Fathomless feature*
...
***Gift of the Sea.*** *1st-level Fathomless feature*

You gain a swimming speed of 40 feet, and you can breathe underwater.

***Oceanic Soul.*** *6th-level Fathomless feature*
...
***Guardian Coil.*** *6th-level Fathomless feature*
...
***Grasping Tentacles.*** *10th-level Fathomless feature*
...
***Fathomless Plunge.*** *14th-level Fathomless feature*
...
***Expanded Spell List.*** *1st-level Genie feature*
...
***Genie's Vessel.*** *1st-level Genie feature*
...
***Elemental Gift.*** *6th-level Genie feature*
...
***Limited Wish.*** *14th-level Genie feature*
...
***Level 3: Undead Spells.*** The magic of your patron ensures you always have certain spells ready; when you reach a Warlock level specified in the Undead Spells table, you thereafter always have the listed spells prepared.
...
***Level 6: Grave Touched.*** Your patron's powers have a profound effect on your body and magic, granting you the following benefits.
...
***Level 10: Necrotic Husk.*** Your connection to undeath saturates your body. You gain the following benefits.
...
***Level 14: Superior Dread.*** Your Form of Dread improves, granting you the following benefits while you are using it.
